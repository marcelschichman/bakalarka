...
${CND_DISTDIR}/${CND_CONF}: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}
	g++ -o ${CND_DISTDIR}/${CND_CONF} ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/BlasrOutput.o: BlasrOutput.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BlasrOutput.o BlasrOutput.cpp

${OBJECTDIR}/DALIGN/DB.o: DALIGN/DB.c 
	${MKDIR} -p ${OBJECTDIR}/DALIGN
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DALIGN/DB.o DALIGN/DB.c

${OBJECTDIR}/DALIGN/QV.o: DALIGN/QV.c 
	${MKDIR} -p ${OBJECTDIR}/DALIGN
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DALIGN/QV.o DALIGN/QV.c

${OBJECTDIR}/DALIGN/align.o: DALIGN/align.c 
	${MKDIR} -p ${OBJECTDIR}/DALIGN
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DALIGN/align.o DALIGN/align.c
...
${OBJECTDIR}/Output.o: Output.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Output.o Output.cpp

${OBJECTDIR}/SAMOutput.o: SAMOutput.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SAMOutput.o SAMOutput.cpp

${OBJECTDIR}/SeedFinder.o: SeedFinder.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SeedFinder.o SeedFinder.cpp

${OBJECTDIR}/SeedFinder_hashmap.o: SeedFinder_hashmap.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SeedFinder_hashmap.o SeedFinder_hashmap.cpp

${OBJECTDIR}/Sequence.o: Sequence.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sequence.o Sequence.cpp
...
${OBJECTDIR}/read_selector.o: read_selector.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/read_selector.o read_selector.cpp

${OBJECTDIR}/simple_test.o: simple_test.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/simple_test.o simple_test.cpp

${OBJECTDIR}/time_test.o: time_test.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/time_test.o time_test.cpp

${OBJECTDIR}/trace_spacing_test.o: trace_spacing_test.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/trace_spacing_test.o trace_spacing_test.cpp
